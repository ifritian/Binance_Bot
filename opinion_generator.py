...
THEMES: dict[str, dict] = {
    ...
    "XRP": {"label": "$XRP", "tickers": ["XRP"]},
    "ADA": {"label": "$ADA", "tickers": ["ADA"]},
    "DOGE": {"label": "$DOGE", "tickers": ["DOGE"]},
    "AVAX": {"label": "$AVAX", "tickers": ["AVAX"]},
    "LINK": {"label": "$LINK", "tickers": ["LINK"]},
    "DOT": {"label": "$DOT", "tickers": ["DOT"]},
