...
# Мемные монеты (SHIB/PEPE) в конце списка - формат специально
# шуточный, они органично ложатся в "а что если" сценарии. Намеренно
# НЕ включены MATIC (делистнут Binance в 2024, заменён на POL) и FTM
# (переименован в Sonic/S в начале 2025) - проверено веб-поиском на
# момент написания, чтобы не подставить в промпт мёртвый тикер.
_TICKERS = [
    "BTC", "ETH", "SOL", "BNB", "XRP", "ADA", "DOGE",
    "AVAX", "LINK", "DOT", "LTC", "TRX", "ATOM", "NEAR", "TON",
    "SHIB", "PEPE",
]
